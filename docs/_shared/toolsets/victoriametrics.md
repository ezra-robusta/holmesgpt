...
For the complete list of supported configuration fields (authentication headers, timeouts, label filters, SSL verification, etc.), see the [Prometheus toolset configuration reference](https://holmesgpt.dev/data-sources/builtin-toolsets/prometheus/#configuration).
...
Inherits every tool from the Prometheus toolset. See the [Prometheus capabilities](https://holmesgpt.dev/data-sources/builtin-toolsets/prometheus/#capabilities) reference for the full list of tools Holmes can use against a VictoriaMetrics endpoint.
