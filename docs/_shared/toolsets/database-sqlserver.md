...
For Azure SQL Database, see the [Azure SQL Database](https://holmesgpt.dev/data-sources/builtin-toolsets/database-sqlserver/#azure-sql-database) section below.
