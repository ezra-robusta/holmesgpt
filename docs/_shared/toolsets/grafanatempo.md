...
| Setup | When to use |
|-------|-------------|
| [Self-Hosted Tempo via Grafana Proxy](https://holmesgpt.dev/data-sources/builtin-toolsets/grafanatempo/#self-hosted-tempo-via-grafana-proxy) (recommended) | You run your own Grafana with a Tempo datasource configured |
| [Self-Hosted Tempo - Direct Connection](https://holmesgpt.dev/data-sources/builtin-toolsets/grafanatempo/#self-hosted-tempo-direct-connection) | Self-hosted Tempo without Grafana, including multi-tenant setups needing `X-Scope-OrgID` |
| [Grafana Cloud](https://holmesgpt.dev/data-sources/builtin-toolsets/grafanatempo/#grafana-cloud) | Your Grafana Cloud stack (queries Tempo via your Grafana Cloud Grafana) |
...
No secret is needed in this mode — direct Tempo connections don't carry an API key.
