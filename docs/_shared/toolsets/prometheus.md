...
- Ensure HolmesGPT can connect to the Prometheus endpoint (see [Finding your Prometheus URL](https://holmesgpt.dev/data-sources/builtin-toolsets/prometheus/#finding-your-prometheus-url))
